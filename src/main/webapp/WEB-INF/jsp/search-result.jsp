...
<html lang="en">
    <head>
        <title>Avia Booking Search</title>
                                ...
                                <form action="/search/submit" method="post">
                                    <div class="home-border">
                                        <div class="home-filter">
                                            ...
                                            <input type="text" name="dCity" value="${dCity}" placeholder="Departure City" class="home-textinput input" />
                                            <input type="text" name="aCity" value="${aCity}" placeholder="Arrival City" class="home-textinput input" />

                                            <input type="date" name="dDate" value="${dDate}" placeholder="Departure Date" class="home-textinput1 input" />
                                            <input type="date" name="aDate" value="${aDate}" placeholder="Arrival Date" class="home-textinput1 input" />
