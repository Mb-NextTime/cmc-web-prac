...
CREATE TABLE aircrafts (
    ...
    n_rows int NOT NULL CONSTRAINT CHECK(n_rows > 0),
    n_cols int NOT NULL CONSTRAINT CHECK(n_cols > 0)
);
...
CREATE TABLE flights (
    ...
    base_price int NOT NULL CONSTRAINT CHECK (base_price > 0)
);
...
CREATE TABLE bookings (
    ...
    price int NOT NULL CONSTRAINT CHECK (price > 0)
);
